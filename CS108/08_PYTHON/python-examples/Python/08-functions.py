...
def my_function(fname, lname):
  print("Hello " + fname + " "+ lname)      # print(f"Hello {fname} {lname}")
...
def adder(*num):
    ...
    print("Sum:",sum)              # comma gives extra space.
...
def intro(**data):
    ...
    for key,value in data.items():                   # remember items() function gives you the key:value pairs in the 
       print(key, " => ", value)

intro(Firstname="Sita", Lastname="Sharma", Age=22, Phone=1234567890)   # passing the whole dict as an argument.
