...
# Sets do not support indexing thus we can't change any item but add/remove using function
...
thisset = {"apple", "banana", "cherry"}
mylist = ["kiwi", "orange"]
thisset.update(mylist)            # added using update method.
print("7", thisset) 
...
# update method just updates the first one in any settings