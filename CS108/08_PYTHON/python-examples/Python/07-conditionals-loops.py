...
for x in fruits:                       #iterates through all the elements in the list.
  if x == "banana":
    continue
  print(x)
...
for x in range(6):                    # ends at specified number less than the given number
  print(x)  

#increments by 3 in this case
for x in range(3, 30, 3):             # start from 2, go till lessthan(30) and increment 3 on each iteration
  print(x)
